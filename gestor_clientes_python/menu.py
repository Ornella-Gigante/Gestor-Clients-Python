"""INTERFAZ QUE UNE EL PROGRAMA PRINCIPAL Y LA BBDD"""
...
def iniciar():
    while True:
        ...
        if opcion== '1':
            ...
            print(cliente) if cliente else print("Cliente no encontrado, pruebe de nuevo")
            ...
            apellidos = helpers.leer_texto(2, 30, "APELLIDO (2 A 30 CHARS)").capitalize()
            ...
            if cliente:
                ...
                apellidos= helpers.leer_texto(2,30,f"APELLIDO(2 A 30 CHARS)[{cliente.nombre}]").capitalize()
                db.Clientes.modificar(cliente.dni, nombre, apellidos)
                print("Cliente modificado correctamente")
            else: 
                print("Cliente no encontrado, inténtelo de nuevo")
        elif opcion == '5':
